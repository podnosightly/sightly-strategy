...
**Hard Rules terminology for anything client-facing.** "Brand Suitability" not "brand safety"; "Social Intelligence" not "social listening"; Brand Mentality®, Anticipation Software®, SmartLists™ with their marks. Never name competitors in client-facing work (use "other offerings in the market"). Never name white-label partners. Never use "programmatic" in Spotify materials. IRIS.TV, Spectrum Reach, and Transmit Live can be named, always leading with Sightly. Never frame Sightly's size as a limitation, and never position Sightly as insight-only — it is always activation-led. If no BAV equity data is provided, frame the tension in plain strategic terms; do not invent a BAV quadrant.
